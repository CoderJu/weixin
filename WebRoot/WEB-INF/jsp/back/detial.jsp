					...
					<table class="tab1">
						...
						<input type="hidden" name="operation" value="add"/>
							<tr>
								...
								<td>
									<textarea  id ="content" type="text" name="content"  rows="3" cols="60"  value="${message.content }"></textarea>
								</td>
								</tr>
	                            	<p class="g_title fix">
	                            	<a class="btn03" href="javascript:add('<%=basePath%>');">新建</a> 				
	                            	<a class="btn03" href="javascript:clean('<%=basePath%>');">清除</a></p>
	       					</tr>
						</tbody>
					</table>
				</div>
